...
import 'package:namaste_yoga/Screens/Startup.dart';
import 'package:namaste_yoga/Widgets/CustomAppBar.dart';
import 'package:namaste_yoga/Widgets/CustomDrawer.dart';
...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _drawerTween = ColorTween(begin: Colors.white, end: Colors.black)
        .animate(_animationController);
    _homeTween = ColorTween(begin: Colors.white, end: Colors.blueGrey)
        .animate(_animationController);
